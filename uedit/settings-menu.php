...
<option value="apache_conf">
Apache Conf
</option>
<option value="asciidoc">
AsciiDoc
</option>
<option value="assembly_x86">
Assembly x86
</option>
<option value="autohotkey">
AutoHotKey
</option>
<option value="batchfile">
BatchFile
</option>
<option value="c9search">
C9Search
</option>
<option value="c_cpp">
C and C++
...
<option value="12px" selected="selected">
12px
</option>
<option value="13px">
13px
...
<option value="markbegin" selected="selected">
mark begin
</option>
<option value="markbeginend">
mark begin and end
</option>
</select>
</td>
...
<td>
<input name="select_style" id="select_style" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="highlight_active">
Highlight Active Line
</label>
</td>
<td>
<input name="highlight_active" id="highlight_active" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
...
<td>
<input name="show_hidden" id="show_hidden" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="display_indent_guides">
Show Indent Guides
</label>
</td>
<td>
<input name="display_indent_guides" id="display_indent_guides" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="show_hscroll">
Persistent HScroll
</label>
</td>
<td>
<input name="show_hscroll" id="show_hscroll" type="checkbox">
<label for="show_hscroll">
VScroll
</label>
<input name="show_vscroll" id="show_vscroll" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="animate_scroll">
Animate scrolling
</label>
</td>
<td>
<input name="animate_scroll" id="animate_scroll" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="show_gutter">
Show Gutter
</label>
</td>
<td>
<input id="show_gutter" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="show_print_margin">
Show Print Margin
</label>
</td>
<td>
<input id="show_print_margin" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
...
<td>
<input id="soft_tab" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
...
<td>
<input id="highlight_selected_word" checked="" type="checkbox">
</td>
</tr>
<tr>
<td>
<label for="enable_behaviours">
Enable Behaviours
</label>
</td>
<td>
...
<tr>
<td>
<label for="scrollPastEnd">
Scroll Past End
</label>
</td>
<td>
<input id="scrollPastEnd" checked="" type="checkbox">
</td>
</tr>
</tbody>
</table>
