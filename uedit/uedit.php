...
<link rel="shortcut icon" href="/img/logo48.png" type="image/x-icon" />
		...
		<script src="scripts/src-noconflict/ext-searchbox.js"></script>
		<script src="scripts/src-noconflict/theme-eclipse.js"></script>
		<script src="scripts/uedit.js" type="text/javascript"></script>
		<!--<script src="scripts/uedit.min.js" type="text/javascript"></script>-->
