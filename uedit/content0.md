...
# Screenshots:
<img class="full-width-img"  alt="screenshot1.png" src="images/screenshot1.png" />
...
It doesn't require any special installation method. It resides on your browser. You just need to visit the page <a href="https://neurobin.github.io/uedit/uedit.html">Go Edit</a> and let the necessary files (~1MB) be downloaded just once. You will then be able to use it offline when all of it's requirements are cached in the browser.
